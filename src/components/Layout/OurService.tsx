...
const OurService = () => {
    return (
        <div>
               ...
               <div className="support-company-area pt-100 pb-100 section-bg fix" style={{ backgroundImage: `url(/assets/img/gallery/section_bg02.jpg)` ,}} >
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-xl-6 col-lg-6">
                                <div className="support-location-img">
                                    <img src="/assets/img/gallery/xabout.png.pagespeed.ic.NolByd-O8M.jpg" alt="" />
                                </div>
                            </div>
                            <div className="col-xl-6 col-lg-6">
